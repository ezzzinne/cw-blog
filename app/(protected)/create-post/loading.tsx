  ...
  return (
    <main className="mx-auto w-full max-w-5xl animate-pulse px-5 py-6 sm:px-8 sm:py-10">
      ...
      <div className="mb-8 mt-8 text-center">
        <div className="mx-auto h-3 w-24 rounded-full bg-primary/15" />
        <div className="mx-auto mt-4 h-10 w-56 rounded-xl bg-muted" />
      </div>
      <div className="rounded-2xl border border-border/70 bg-card/80 p-5 shadow-lg shadow-primary/5 sm:p-8">
        <div className="space-y-5">
          ...
          <div className="ml-auto h-11 w-32 rounded-full bg-primary/20" />
        </div>
      </div>
    </main>
  );
